alter table public.profiles
  add column if not exists safety_accepted_at timestamptz null;

grant insert (id, username, display_name, safety_accepted_at) on public.profiles to authenticated;
grant update (username, display_name, safety_accepted_at, updated_at) on public.profiles to authenticated;
