drop function if exists public.find_or_create_match(text, text, text, text, boolean);
...
revoke all on function public.find_or_create_match(text, text, text, text, boolean, boolean) from public;
revoke all on function public.find_or_create_match(text, text, text, text, boolean, boolean) from anon;
grant execute on function public.find_or_create_match(text, text, text, text, boolean, boolean) to authenticated;
