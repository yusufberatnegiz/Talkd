export const TOPICS = {
  ...
  advice: { key: 'advice', label: 'Life Advice',        hint: 'just need a second opinion',                hue: '#5F91C8', n: 18 },
  any:    { key: 'any',    label: 'Other',              hint: 'pick a stranger, figure it out together',   hue: '#C27DBC', n: 11 },
} as const;
